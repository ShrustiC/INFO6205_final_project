...
import edu.neu.coe.info6205.Helper;
...
public class MSDStringSortTest {
    ...
    static String[] getWords(final String resource, final Function<String, List<String>> stringListFunction) {
        final String[] result = getWordArray("./target/classes/" + resource, stringListFunction, 2);
        return result;
    }
     ...
     * @return an array of Strings.
     */
    static String[] getWordArray(final String fileName, final Function<String, List<String>> stringListFunction, final int minLength) {
